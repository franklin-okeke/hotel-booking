  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
           <Link href='/'>
            <h1 className='text-3xl cursor-pointer text-blue-500 font-bold'>Royal Hotels</h1>
           </Link>
            <p className="text-sm/7 mt-6">
              Discover the world most extraordinary place to relax from vacations to business deals etc.. our rooms and amenities are topnotch
            </p>
        </div>
    ...
    <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
        <p className="text-center">
            Copyright {new Date().getFullYear()} © <a href="https://www.frotechintl.com">FroTech Intl</a> All Right Reserved.
        </p>
